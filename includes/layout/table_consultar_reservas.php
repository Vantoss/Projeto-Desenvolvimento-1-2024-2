        ...
        foreach ($arr as $_ => $row){?>
            <tr>
                ...
                <td><div class="d-grid gap-2 d-md-flex justify-content-md-center">
                    <button type="button" class="btn-editar-reserva btn btn-primary" data-bs-toggle="modal" value="<?php echo $row['id-reserva']?>" data-bs-target="#editar-reserva-modal">Editar</button>
                    <button type="button" class="btn-deletar-reserva btn btn-danger" data-bs-toggle="modal" value="<?php echo $row['id-reserva']?>" data-bs-target="#deletar-reserva-modal">Deletar</button>
                </div>
                </td> 
            </tr>
            <?php }?>
