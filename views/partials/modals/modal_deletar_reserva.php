<div class="modal fade" id="deletar-reserva-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <form method="get" id="form-del-reserva">
        <input type="hidden" id="del-reserva-id-reserva" value="" name="id-reserva">
        <input type="hidden" id="del-reserva-id-turma" value="" name="id-turma">
