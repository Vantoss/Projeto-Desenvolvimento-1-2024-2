            ...
            <div class="row text-center">
              ...
              <div class="col">
                <div class="form-floating ">
                  <input type="text" class="form-control mb-3" id="inp-turma" placeholder="Turma" name="nome" autocomplete="off" >
                  <label for="inp-turma" class="form-label">Turma</label>
                </div>
                
                <!-- INPUT DOCENTE -->
                <div class="form-floating ">
                  <input type="text" class="form-control mb-3" id="inp-docente" placeholder="Docente" name="docente" autocomplete="off" >
                  <label for="inp-docente" class="form-label">Docente</label>
                </div>
                
                <!-- INPUT CURSO -->
                <div class="form-floating ">
                  <input type="text" class="form-control mb-3" id="inp-curso" placeholder="Curso" name="curso" autocomplete="off" >
                  <label for="inp-curso" class="form-label">Curso</label>
                </div>

                <!-- INPUT SEMESTRE -->
                <div class="form-floating ">
                    <input type="text" class="form-control mb-3" id="inp-semestre" placeholder="Semestre" name="semestre" autocomplete="off" >
